...
class V8_EXPORT CpuProfiler {
 public:
  /**
   * Creates a new CPU profiler for the |self|. The self must be
   ...
   * the |self|. The call does not affect number of ticks recorded for
...
class V8_EXPORT CodeEventHandler {
 public:
  /**
   * Creates a new listener for the |self|. The self must be initialized.
   * The listener object must be disposed after use by calling |Dispose| method.
   * Multiple listeners can be created for the same self.
   */
