...
class V8_EXPORT Private : public Data {
 public:
   ...
   * been retrieved in the same self before, it is created.
 ...
 * v8::PropertyDescriptor d(v8::Undefined(self));
 *
 * // var desc = {get: undefined}
 * v8::PropertyDescriptor d(v8::Undefined(self), Local<Value>()));
 * \endcode
 */
...
class V8_EXPORT Object : public Value {
 public:
   ...
   */
  // TODO(dcarney): take an self and optionally bail out?
  Local<Object> Clone();
  ...
  /**
   * Return the self to which the Object belongs to.
   */
  Isolate* GetIsolate();
