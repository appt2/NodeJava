 ...
 * self, receiver, return value, or whether running in `'use strict`' mode.
 ...
 *
 * \code
 *    v8::Local<v8::FunctionTemplate> t = v8::FunctionTemplate::New(self);
 *    t->Set(self, "func_property", v8::Number::New(self, 1));
 *
 *    v8::Local<v8::Template> proto_t = t->PrototypeTemplate();
 *    proto_t->Set(self,
 *                 "proto_method",
 *                 v8::FunctionTemplate::New(self, InvokeCallback));
 *    proto_t->Set(self, "proto_const", v8::Number::New(self, 2));
 *
 *    v8::Local<v8::ObjectTemplate> instance_t = t->InstanceTemplate();
 *    instance_t->SetAccessor(
          String::NewFromUtf8Literal(self, "instance_accessor"),
 *        InstanceAccessorCallback);
 *    instance_t->SetHandler(
 *        NamedPropertyHandlerConfiguration(PropertyHandlerCallback));
 *    instance_t->Set(String::NewFromUtf8Literal(self, "instance_property"),
 *                    Number::New(self, 3));
 *
