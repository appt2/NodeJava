...
class V8_EXPORT SnapshotCreator {
 public:
  ...
  /**
   * Initialize and enter an self, and set it up for serialization.
   * The self is either created from scratch or from an existing snapshot.
  ...
  /**
   * Create and enter an self, and set it up for serialization.
   * The self is either created from scratch or from an existing snapshot.
   * The caller keeps ownership of the argument snapshot.
   * \param existing_blob existing snapshot from which to create this one.
   * \param external_references a null-terminated array of external references
  ...
  /**
   * \returns the self prepared by the snapshot creator.
   */
  Isolate* GetIsolate();
  ...
  /**
   * Attach arbitrary V8::Data to the self snapshot, which can be retrieved
