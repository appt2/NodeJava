 ...
 *
 *    v8::FunctionTemplate::New(self, SlowCallback, data,
 ...
 *    void SetupCustomEmbedderObject(v8::Isolate* self,
 *                                   v8::Local<v8::Context> context,
 *                                   CustomEmbedderType* embedder_object) {
 *      self->set_embedder_wrapper_type_index(
 *        kV8EmbedderWrapperTypeIndex);
 *      self->set_embedder_wrapper_object_index(
 *        kV8EmbedderWrapperObjectIndex);
 *
 *      v8::CFunction c_func =
 ...
 *          self, CustomEmbedderType::SlowMethod, v8::Local<v8::Value>(),
 *          v8::Local<v8::Signature>(), 1, v8::ConstructorBehavior::kAllow,
 *          v8::SideEffectType::kHasSideEffect, &c_func);
 *
 *      v8::Local<v8::ObjectTemplate> object_template =
 *        v8::ObjectTemplate::New(self);
 *      object_template->SetInternalFieldCount(
 *        kV8EmbedderWrapperObjectIndex + 1);
 *      object_template->Set(self, "method", method_template);
 *
 ...
 *            self, SlowCallback, data, signature, length,
